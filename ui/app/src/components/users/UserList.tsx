...
import type { Action, UserResource } from '@perses-dev/client';
...
import { CREATED_AT_COL_DEF, NAME_COL_DEF, UPDATED_AT_COL_DEF, VERSION_COL_DEF } from '../list';
import type { Row } from './UserDataGrid';
