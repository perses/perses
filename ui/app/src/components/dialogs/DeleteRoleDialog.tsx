...
interface DeleteRoleDialogProps<T extends Role> {
  role: T;
  open: boolean;
  onSubmit: Dispatch<T>;
...
/**
 * Dialog used to delete a role.
 * @param props.role The role resource to delete.
 ...
 */
export function DeleteRoleDialog<T extends Role>(props: DeleteRoleDialogProps<T>) {
  const { role, open, onClose, onSubmit } = props;
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      ...
      <Dialog.Actions>
        <Button variant="contained" type="submit" onClick={() => onSubmit(role)}>
          Delete
        </Button>
