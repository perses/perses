...
function RoleBindingsGridToolbar() {
  return (
    <GridToolbarContainer>
...
function NoRoleBindingRowOverlay() {
  return (
    <Stack sx={{ alignItems: 'center', justifyContent: 'center', height: '100%' }}>
      <Typography>No role bindings</Typography>
    </Stack>
  );
}

export interface RoleBindingDataGridProperties {
...
export function RoleBindingDataGrid(props: RoleBindingDataGridProperties) {
    ...
    <DataGrid
      ...
      slots={
        hideToolbar
          ...
          : {
              toolbar: RoleBindingsGridToolbar,
              row: MemoizedRow,
