...
const ProfileSettings = ({ selectedView, setSelectedView }: IProps): ReactElement => {
  const accountSettingsItems: IAccountSettingItem[] = [
    ...
    /* TODO: Should be added later */
    {
      ...
      view: ProfileSections.AUTHENTICATION,
  ...
  const handleViewChange = (view: ProfileSections) => {
        ...
        <React.Fragment key={s.title}>
          ...
          <List>
            {s.items.map((i) => (
              <ListItem
                role="button"
                aria-selected={selectedView === i.view}
                key={i.view}
