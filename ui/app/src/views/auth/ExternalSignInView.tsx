...
import { useExternalAuthWhoami, useRedirectQueryParam } from '../../model/auth-client';
...
function ExternalSignInView(): ReactElement {
  ...
  const authCheck = useExternalAuthWhoami(externalProvider);
  ...
  }, [authCheck.status, authCheck.error?.message, successSnackbar, navigate, exceptionSnackbar, redirectPath]);
