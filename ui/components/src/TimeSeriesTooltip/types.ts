...
/**
 * Candidate represents a series that is a potential match for the cursor position.
 * It includes the visual Y position (accounting for stacking) and distance metric.
 */
