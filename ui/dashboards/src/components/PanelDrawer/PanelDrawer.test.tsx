...
import { TimeRangeProvider, ValidationProvider } from '@perses-dev/plugin-system';
import { z } from 'zod';
import { createDashboardProviderSpy, getTestDashboard, renderWithContext } from '../../test';
import { DashboardProvider } from '../../context/DashboardProvider';
import { TemplateVariableProvider } from '../../context/TemplateVariableProvider';
...
describe('Panel Drawer', () => {
  const renderPanelDrawer = () => {
    ...
    renderWithContext(
      <ValidationProvider initialPanelEditorFormSchema={z.object({})}>
