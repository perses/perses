...
const meta: Meta<typeof PluginKindSelect> = {
  component: PluginKindSelect,
  render: (args) => {
...
type Story = StoryObj<typeof PluginKindSelect>;

export const Primary: Story = {
  args: { pluginType: 'Panel', required: true, labelId: 'panel-type-label', label: 'Type', value: 'Markdown' },
};
