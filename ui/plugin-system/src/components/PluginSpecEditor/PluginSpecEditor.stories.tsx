...
const meta: Meta<typeof PluginSpecEditor> = {
  component: PluginSpecEditor,
  render: (args) => {
...
type Story = StoryObj<typeof PluginSpecEditor>;

export const Primary: Story = {
  args: { pluginType: 'Panel', pluginKind: 'Markdown', value: { text: '## Example' } },
};
