...
import { QueryDefinition, UnknownSpec, AbsoluteTimeRange, ProfileData } from '@perses-dev/core'; // cannot understand this because this interface has been exported from .\ui\core\src\model\profile-data.ts
