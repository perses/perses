...
MDOX_MD_FILES_CMD     = find . -name '*.md' -not -path "./docs/*" -not -path "./.github/perses-ci/*" -not -path "./ui/node_modules/*" -not -path "./ui/app/node_modules/*" -not -path "./ui/docs/node_modules/*" -not -path "./ui/storybook/node_modules/*" -print
