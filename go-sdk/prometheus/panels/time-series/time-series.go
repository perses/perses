...
func (b *PanelPluginBuilder) WithLegend(legend Legend) *PanelPluginBuilder {
	b.Legend = &legend
	return b
}

func (b *PanelPluginBuilder) WithTooltip(tooltip Tooltip) *PanelPluginBuilder {
	b.Tooltip = &tooltip
	return b
}

func (b *PanelPluginBuilder) WithYAxis(yAxis YAxis) *PanelPluginBuilder {
	b.YAxis = &yAxis
	return b
}
...
func (b *PanelPluginBuilder) WithVisual(visual Visual) *PanelPluginBuilder {
	b.Visual = &visual
	return b
}
