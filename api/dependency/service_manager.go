...
import (
	"github.com/perses/perses/api/crypto"
	dashboardImpl "github.com/perses/perses/api/impl/v1/dashboard"
	datasourceImpl "github.com/perses/perses/api/impl/v1/datasource"
	ephemeralDashboardImpl "github.com/perses/perses/api/impl/v1/ephemeraldashboard"
	folderImpl "github.com/perses/perses/api/impl/v1/folder"
	globalDatasourceImpl "github.com/perses/perses/api/impl/v1/globaldatasource"
	globalRoleImpl "github.com/perses/perses/api/impl/v1/globalrole"
	globalRoleBindingImpl "github.com/perses/perses/api/impl/v1/globalrolebinding"
	globalSecretImpl "github.com/perses/perses/api/impl/v1/globalsecret"
	globalVariableImpl "github.com/perses/perses/api/impl/v1/globalvariable"
	healthImpl "github.com/perses/perses/api/impl/v1/health"
	projectImpl "github.com/perses/perses/api/impl/v1/project"
	roleImpl "github.com/perses/perses/api/impl/v1/role"
	roleBindingImpl "github.com/perses/perses/api/impl/v1/rolebinding"
	secretImpl "github.com/perses/perses/api/impl/v1/secret"
	userImpl "github.com/perses/perses/api/impl/v1/user"
	variableImpl "github.com/perses/perses/api/impl/v1/variable"
	viewImpl "github.com/perses/perses/api/impl/v1/view"
	"github.com/perses/perses/api/interface/v1/dashboard"
	"github.com/perses/perses/api/interface/v1/datasource"
	"github.com/perses/perses/api/interface/v1/ephemeraldashboard"
	"github.com/perses/perses/api/interface/v1/folder"
	"github.com/perses/perses/api/interface/v1/globaldatasource"
	"github.com/perses/perses/api/interface/v1/globalrole"
	"github.com/perses/perses/api/interface/v1/globalrolebinding"
	"github.com/perses/perses/api/interface/v1/globalsecret"
	"github.com/perses/perses/api/interface/v1/globalvariable"
	"github.com/perses/perses/api/interface/v1/health"
	"github.com/perses/perses/api/interface/v1/project"
	"github.com/perses/perses/api/interface/v1/role"
	"github.com/perses/perses/api/interface/v1/rolebinding"
	"github.com/perses/perses/api/interface/v1/secret"
	"github.com/perses/perses/api/interface/v1/user"
	"github.com/perses/perses/api/interface/v1/variable"
	"github.com/perses/perses/api/interface/v1/view"
	"github.com/perses/perses/api/plugin"
	"github.com/perses/perses/api/plugin/migrate"
