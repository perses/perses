...
# Name of the userinfo property to use as the "login" of the user (e.g. "preferred_username").
# It must be one of the properties Perses already extracts from the userinfo response
# (name, given_name, family_name, middle_name, nickname, preferred_username, email).
