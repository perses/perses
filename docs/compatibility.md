...
This document is here to explain what does it mean for a software or a tool to be compatible with Perses.

!!! warning
    This documentation can change over the time. So a software that said it is compatible with Perses today may not be compatible anymore in the future if Perses changes its specifications or APIs. 
...
Note that, the dashboard definition is including the datasource definition. So being compatible with Perses also means that your software needs to support and manage the data-sources. But it does not mean that your software needs to support the same datasource as Perses.
