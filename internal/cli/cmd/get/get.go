...
import (
	...
	"github.com/perses/perses/internal/cli/cmd/get/service"
...
func (o *option) complete(args []string) error {
	...
	if len(args) <= 0 {
		return fmt.Errorf(cmdUtils.FormatAvailableResourcesMessage("you should specify the resource type that you want to retrieve. Valid resource type include:"))
	} else if len(args) == 2 {
	...
	svc, svcErr := service.NewService(o.kind, o.project, o.apiClient)
	if svcErr != nil {
		return err
	}
