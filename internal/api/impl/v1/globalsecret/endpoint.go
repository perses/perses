...
func NewEndpoint(service globalsecret.Service, rbacService authorization.RBAC, readonly bool) *Endpoint {
	return &Endpoint{
		toolbox:  shared.NewToolBox(service, rbacService, v1.KindGlobalSecret),
		readonly: readonly,
	}
}
