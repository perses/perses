...
func NewEndpoint(service ephemeraldashboard.Service, rbacService rbac.RBAC, readonly bool) route.Endpoint {
	return &endpoint{
		toolbox:  shared.NewToolBox(service, rbacService, v1.KindEphemeralDashboard),
		readonly: readonly,
	}
}
